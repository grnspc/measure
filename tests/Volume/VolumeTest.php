...
use Grnspc\Measures\Unit\Volume\UnitsOfVolume;
...
it('can use extended names to convert units', function () {
    ...
    expect($volume->toCubicMeters()->value)->toBe(0.002)
        ...
        ->and($volume->toCubicInches()->value)->toBe(122.0475)
        ->and($volume->toGallons()->value)->toBe(0.5283)
        ->and($volume->toPints()->value)->toBe(4.2268)
        ->and($volume->toCups()->value)->toBe(8.4535);
});
