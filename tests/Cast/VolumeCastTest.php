...
use Grnspc\Measures\Tests\TestModels\CastableVolumeObject;
...
})->throws(InvalidArgumentException::class, 'The value must be an instance of Grnspc\Measures\Unit\Volume\Volume');
